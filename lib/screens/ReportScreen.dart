...
class ReportScreen extends StatelessWidget {
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text("Báo cáo mới nhất", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
        ),
        Container(
            height: 500,
            child: lastestReport()
  ...
  Widget indexReport(String title, String subtitle, int _int_color) {
    ...
    if (_int_color == 0)
      _color = Color.fromRGBO(32, 108, 164, 1);
          ...
          child: Container(
              ...
              child: ListTile(
                leading: SizedBox(
                  child: DecoratedBox(
                    child: Icon(
                      Icons.library_books_sharp, color: _color,),
                    decoration: BoxDecoration(
