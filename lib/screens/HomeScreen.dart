...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: ListView(children: <Widget>[
        ...
        Row(children: <Widget>[
          ...
          Padding(
            ...
            child: IconButton2(
              ...
              buttonHeight: 70,
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (context) => AddHealthRecord()))
            ),
          ),
          Padding(
            padding: EdgeInsets.only(left: 15, top: 20),
            child: IconButton2(
              ...
              buttonHeight: 70,
              onPressed: () => Navigator.push(context,
                  MaterialPageRoute(builder: (context) => FindPharmacyScreen(drugs: [])))
            ),
          ),
        ]),
        Center(
        ...
        Container(
            height: 225,
            child: (globals.listAccount!=null?ListView.builder(
                        ...
                        Padding(
                          ...
                          child:  Center(
                            child: Padding(
                              ...
                              child: Appointment(
                                day1: globals.listAccount![index].selectedDate.day.toString(),
                                day2: 'T' + globals.listAccount![index].selectedDate.month.toString(),
                                time: globals.listAccount![index].startTime.hour.toString()+':'+globals.listAccount![index].startTime.minute  .toString(),
                                doctorName: globals.listAccount![index].doctor.name,
                                faculty: 'Bác sĩ ',
